        ...
        <section class="background_header bg-green" style="height: 45%">
            <div class="npPage_SuccessPkg">
                <div class="txt">
                    ...
                    <br>
                    <a href="{{route('applicant.contract.details', ['id' => $contract->id])}}"><button class="btn w-100 bg-success m-0 color-white align-items-center rounded-10 justify-content-center">Révisez votre contrat</button></a>
                </div>
            </div>
        </section>
@endsection
