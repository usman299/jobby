    ...
    <section class="emPageAbout padding-t-60">
        <div class="em__signTypeOne padding-30 bg-white">
            ...
            <div class="em__body px-0">
                <form method="POST" action="{{route('app.add.walet')}}" id="payment-form" class="paymentformsubmit" enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="balance" value="{{$balance}}">

                    <div class="form-group input-lined">
                        <label for="price" class="margin-t-20" style="font-size: 15px;"> <strong>Paiement</strong> <strong style="color: red;">: {{$balance}} €</strong> </label>
                    </div>
                    ...
                    <div class="form-group input-lined">
                        ...
                        <label for="description" class="margin-t-20" style="font-size: 15px;"> <strong>Card number</strong> </label>
                    </div>
