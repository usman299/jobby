...
@section('content')
    <section class="padding-t-40 components_page padding-b-30">
        ...
        <a href="{{route('app.subscription.details')}}">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="icon">
                                            <img style="width: 50px;height: 50px;"
                                                 src="{{asset('assets/img/icon/icons8-subscription-64.png')}}" alt="">
                                        </div>
                ...
                @foreach($subscription as $row )
                    ...
                    @elseif($row->id==2)
                        <div class="item" style="margin-top: 20px;">
                            <a href="{{route('app.pay.subscription',['id'=>$row->id])}}" class="box__ele design-color"
                               style="background-color: #009fde!important;">
                                <div class="icon">
                    ...
                    @else
                        <div class="item" style="margin-top: 20px;">
                            <a href="{{route('app.pay.subscription',['id'=>$row->id])}}" class="box__ele business-color"
                               style="background-color: #00deee!important;">
                                <div class="icon">
                                    <img src="{{asset('assets/img/icon/working-hours.svg')}}" alt="">
                                </div>
                                <div class="txt">
