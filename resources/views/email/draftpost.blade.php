...
<table>
    <tr style="background-color: #1fa0b6;">
        <td style="text-align: center; color: white;">
            <h1>Remplissez votre demande d'emploi</h1>
        </td>
    </tr>
    <tr>
...
<table style="background-color: #1fa0b6;">
    ...
    <tr>
        <td style="text-align: center; color: white">
            <h1>Bonjour,</h1>
            <p>
                Vous avez commencé à remplir une demande de service pour {{$draft->sub->title??$draft->child->title??''}}, mais vous ne l’avez pas terminée.

                Finalisez votre demande pour trouver des prestataires compétents !</p>
            <br>
