                            ...
                            <div class="basic-form">
                                <form method="POST" action="{{ route('subcategory.update',['id'=>$subcategory->id]) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control" value="{{$subcategory->price}}" name="price">
                                    </div>
{{--                                    <div class="form-group row">--}}
{{--                                        <label class="col-sm-3 col-form-label"><!--Icon-->Icône<strong--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary"><!-- Sign in -->Soumettre
                                            </button>
                                        </div>
                                    </div>
                                </form>
