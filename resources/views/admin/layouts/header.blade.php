                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu rounded dropdown-menu-right">
                                            ...
                                            @foreach($contacts as $row)
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" loading="lazy"
                                                             src="{{asset($row->user->image)}}">
                                                    </div>
                                                    <div class="media-body">
                                                        <a href="{{route('contact.details', ['id' => $row->id])}}"><h5
                                                                class="mb-1">{{$row->user->firstName}} {{$row->user->firstName}}</h5>
                                                            <small
                                                                class="d-block"><strong>{{Str::limit($row->subject, 22)}}</strong></small>
                                                            <small
                                                                class="d-block">{{Str::limit($row->message, 22)}}</small>
                                                        </a>
                                                    </div>
                                                </div>
                                            @endforeach
                            ...
                            @if($contacts->count()>=5)
                                <a class="all-notification" href="{{route('demandeur.contact')}}">Voir toutes les
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            ...
                            <div class="header-info">
                                @if(Auth::check())
                                    <span
                                        class="text-black"><strong>{{Auth::user()->fname}}  {{Auth::user()->lname}}</strong></span>
                                    @if(Auth::user()->role=='0')
