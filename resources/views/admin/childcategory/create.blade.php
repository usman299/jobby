                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="{{ route('subcategory.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label"><!-- category -->Sou Catégorie <strong style="color: red;font-size: 20px;"> *</strong></label>
                                        <div class="col-sm-9">
                                            <select name="subcategory_id" id="subcategory_id" class="form-control category_id" required="">
...
{{--                $('#subcategory_id').html('<option value="">Choisir une sou catégorie</option>');--}}
{{--                var id = $(this).val();--}}

{{--                $.ajax({--}}
{{--                    method:"GET",--}}
{{--                    url: "{{url('/fetchsubcategory')}}/"+id,--}}
{{--                    async: false,--}}
...
{{--                    },--}}
{{--                    error: function() {--}}
{{--                        $('#option').html('<option value="">Sou Catégorie non disponible</option>');--}}
{{--                    }--}}
{{--                });--}}
