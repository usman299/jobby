                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST"
                                      action="{{ route('childcategory.update',['id'=>$childcategory->id]) }}"
                                    ...
                                    {{--                                    </div>--}}
{{--                                    <div class="form-group row">--}}
{{--                                        <label class="col-sm-3 col-form-label"><!--Icon-->Image<strong--}}
{{--                                                style="color: red;font-size: 20px;"> * </strong></label>--}}
{{--                                        <div class="col-sm-5">--}}
{{--                                            <label class="form-control @error('img') is-invalid @enderror">--}}
{{--                                                <center><i class="fa fa-image"></i> <!-- Add Your Image --> <strong--}}
{{--                                                        style="font-size: 18px;">Ajoutez Votre Icône</strong></center>--}}
{{--                                                <input type="file" style="display: none;" name="img"--}}
{{--                                                       value="{{ old('img') }}"--}}
{{--                                                       accept="image/png, image/gif, image/jpeg" id="imgInp1"--}}
{{--                                                       onchange="preview_image1(event)">--}}
{{--                                            </label>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-sm-4">--}}
{{--                                            <img id="output_image1" loading="lazy"--}}
{{--                                                 src="{{asset($childcategory->img)}}"/>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    <div class="form-group row">
                                        <label for="">Prix</label>
                                        <input type="text" class="form-control" value="{{$childcategory->price}}" name="price">
                                    </div>
                                    {{--                                    <div class="form-group row">--}}
