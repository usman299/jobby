                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><!-- New Category --> Réussites</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="{{route('testi.update',['id'=>$testi->id]) }}" enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label"><!-- Title --><strong>Nom</strong> <strong style="color: red;font-size: 20px;"> *</strong></label>
                                        <div class="col-sm-4" style="margin-top: 20px">
                                            <input type="text" class="form-control" value="{{$testi->name}}" name="name" placeholder="Nom">
                                        </div>
                                        <label class="col-sm-2 col-form-label"><!-- Title --><strong>Destination</strong> <strong style="color: red;font-size: 20px;"> *</strong></label>
                                        <div class="col-sm-4" style="margin-top: 20px">
                                            <input type="text" class="form-control" value="{{$testi->destination}}" name="destination" placeholder="Destination">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <img id="output_image2" src="{{asset($testi->image)}}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 20px">
                                            <textarea class="summernote" name="description"   >{{$testi->description}}</textarea>
                                        </div>
                                    </div>
