                                ...
                                <form method="POST" action="{{route('testi.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4" style="margin-top: 20px">
                                            <input type="text" class="form-control" value="" name="name" placeholder="Nom">
                                        </div>
                                        <label class="col-sm-2 col-form-label"><!-- Title --><strong>Destination</strong> <strong style="color: red;font-size: 20px;"> *</strong></label>
                                        <div class="col-sm-4" style="margin-top: 20px">
                                            <input type="text" class="form-control" value="" name="destination" placeholder="Destination">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                                ...
                                                <img id="output_image2" src="{{asset('images/avatar.png')}}" />
