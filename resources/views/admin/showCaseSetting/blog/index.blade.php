                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-lg-right">
                            ...
                            <a href="{{route('blog.create')}}" class="btn btn-primary">Ajouter un nouveau</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{route('blog.edit', ['id' => $row->id])}}" id="edit" class="btn btn-primary shadow btn-xs sharp"  title="Edit">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="{{route('blog.delete', ['id' => $row->id])}}" id="delete" class="btn btn-danger shadow btn-xs sharp" data-toggle="tooltip" title="Delete">
