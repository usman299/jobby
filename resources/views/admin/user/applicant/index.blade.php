...
{{--                                <option--}}
{{--                                    value="{{route('search.applicant.country',['id'=>$row->id] ) }}">{{$row->name}}</option>--}}
{{--                            @endforeach--}}
{{--                        </select>--}}
{{--                    </div>--}}
{{--                </div>--}}
                                            ...
                                            <div class="d-flex">
                                                ...
                                                @if($row->status == '0')
                                                    <a href="{{route('user.status', ['status'=> '1', 'id' => $row->id])}}"
                                                       class="btn btn-success shadow btn-xs sharp" title="Activate"><i
                                                            class="fa fa-user-plus"></i></a>
                                                @else
                                                    <a href="{{route('user.status', ['status'=> '0', 'id' => $row->id])}}"
                                                       class="btn btn-danger shadow btn-xs sharp"
                                                       style="background-color: red;" title="Deactivate"> <i
