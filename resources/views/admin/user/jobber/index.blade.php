...
{{--                                <option--}}
{{--                                    value="{{route('search.jobber.country',['id'=>$row->id] ) }}">{{$row->name}}</option>--}}
{{--                            @endforeach--}}
{{--                        </select>--}}
{{--                    </div>--}}
{{--                </div>--}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @if($row->status == '0')
                                                    <a href="{{route('user.status', ['status'=> '1', 'id' => $row->id])}}"
                                                       class="btn btn-success shadow btn-xs sharp" title="Activate"
                                                       id="toastr-success-top-full-width"> <i
                                                            class="fa fa-user-plus"></i></a>
                                                @else
                                                    <a href="{{route('user.status', ['status'=> '0', 'id' => $row->id])}}"
                                                       class="btn btn-danger shadow btn-xs sharp" title="Deactivate"
                                                       id="toastr-warning-top-right" style="background-color: red;"> <i
