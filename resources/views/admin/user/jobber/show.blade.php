                        ...
                        <div class="profile-head">
                            ...
                            <div class="profile-info">
                                <div class="profile-photo">
                                    <a target="_blank" href="{{asset($jobber->image ?? '')}}"><img
                                            src="{{asset($jobber->image ?? '')}}" style="height: 100px; width: 100px"
                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#document">Vérifications de
                                            documents</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade" id="document">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @else
                                                    <a href="{{route('mark.jobber.verified', ['id' => $jobber->id])}}">
                                                        <button
                                                            onclick="return confirm('Êtes-vous sûr de vouloir marquer ce jobber comme jobber vérifié')"
                                                            class="btn btn-primary">Mark Verified
                                                        </button>
                                                    </a>
                                                @endif
                                            </div>
