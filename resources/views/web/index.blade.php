...
<div class="page">
                    ...
                    <div class="rd-navbar-main">
                        ...
                        <div class="rd-navbar-panel">
                            ...
                            <div class="rd-navbar-brand">
                                <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="{{asset('front/images/logo-default-286x52.png')}}" alt="" width="143" height="26"/><img class="brand-logo-light" src="{{asset('front/images/logo-inverse-286x52.png')}}" alt="" width="143" height="26"/></a>
                            </div>
                        </div>
                                ...
                                <div class="rd-navbar-popup bg-gray-100" id="rd-navbar-register">
                                    ...
                                    <form class="rd-form rd-mailform form-compact" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                                        <div class="form-wrap">
                                            ...
                                            <label class="form-label" for="rd-navbar-register-name">Username</label>
                                        </div>
                                        <div class="form-wrap">
                                        ...
                                        <div class="form-wrap">
                                            <input class="form-input" id="rd-navbar-register-password" type="password" name="password" data-constraints="@Required"/>
                                            <label class="form-label" for="rd-navbar-register-password">Password</label>
                                        </div>
                                        <div class="form-wrap">
                                            <input class="form-input" id="rd-navbar-register-password-confirm" type="password" name="password-confirm" data-constraints="@Required"/>
                        ...
                        <table class="table-job-offers table-responsive">
                            <tr>
                                ...
                                <td class="table-job-offers-main">
                                    ...
                                    <article class="company-light">
                                        <figure class="company-light-figure"><img class="company-light-image" src="images/company-1-45x45.png" alt="" width="45" height="45"/>
                                        </figure>
                            ...
                            <tr>
                                ...
                                <td class="table-job-offers-main">
                                    <!-- Company Light-->
                                    <article class="company-light">
                                        <figure class="company-light-figure"><img class="company-light-image" src="images/company-2-38x49.png" alt="" width="38" height="49"/>
                                        </figure>
                                        <div class="company-light-main">
                            ...
                            <tr>
                                ...
                                <td class="table-job-offers-main">
                                    <!-- Company Light-->
                                    <article class="company-light">
                                        <figure class="company-light-figure"><img class="company-light-image" src="images/company-3-46x52.png" alt="" width="46" height="52"/>
                                        </figure>
                                        <div class="company-light-main">
                            ...
                            <tr>
                                ...
                                <td class="table-job-offers-main">
                                    <!-- Company Light-->
                                    <article class="company-light">
                                        <figure class="company-light-figure"><img class="company-light-image" src="images/company-4-50x49.png" alt="" width="50" height="49"/>
                                        </figure>
                                        <div class="company-light-main">
                            ...
                            <tr>
                                ...
                                <td class="table-job-offers-main">
                                    <!-- Company Light-->
                                    <article class="company-light">
                                        <figure class="company-light-figure"><img class="company-light-image" src="images/company-5-48x44.png" alt="" width="48" height="44"/>
                                        </figure>
                                        <div class="company-light-main">
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-carousel-profile" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-fade="true" data-margin="30" data-mouse-drag="false">
                <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
                    <figure class="profile-classic-figure"><img class="profile-classic-image" src="images/candidates-grid-1-266x219.jpg" alt="" width="266" height="219"/>
                    </figure>
                ...
                <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
                    <figure class="profile-classic-figure"><img class="profile-classic-image" src="images/candidates-grid-2-266x219.jpg" alt="" width="266" height="219"/>
                    </figure>
                    <div class="profile-classic-main">
                ...
                <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
                    <figure class="profile-classic-figure"><img class="profile-classic-image" src="images/candidates-grid-3-266x219.jpg" alt="" width="266" height="219"/>
                    </figure>
                    <div class="profile-classic-main">
                ...
                <!-- Profile Classic--><a class="profile-classic" href="resume-page.html">
                    <figure class="profile-classic-figure"><img class="profile-classic-image" src="images/candidates-grid-4-266x219.jpg" alt="" width="266" height="219"/>
                    </figure>
                    <div class="profile-classic-main">
            ...
            <div class="container">
                ...
                <div class="owl-carousel" data-items="1" data-md-items="2" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-autoplay="true" data-mouse-drag="false">
                    <blockquote class="quote-mary">
                        ...
                        <div class="quote-mary-meta"><img class="quote-mary-avatar" src="images/user-2-73x73.jpg" alt="" width="73" height="73"/>
                    ...
                    <blockquote class="quote-mary">
                        ...
                        <div class="quote-mary-meta"><img class="quote-mary-avatar" src="images/user-1-73x73.jpg" alt="" width="73" height="73"/>
                            <div class="quote-mary-info">
                    ...
                    <blockquote class="quote-mary">
                        ...
                        <div class="quote-mary-meta"><img class="quote-mary-avatar" src="images/user-4-73x73.jpg" alt="" width="73" height="73"/>
                            <div class="quote-mary-info">
    ...
    <section class="parallax-container section-md bg-primary bg-overlay-1 text-center" data-parallax-img="images/parallax-2.jpg">
        <div class="parallax-content">
            <div class="container container-fullwidth">
                ...
                <!-- Owl Carousel-->
                <div class="owl-carousel owl-carousel-stretch" data-autoplay="true" data-autoplay-timeout="4000" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-xxl-items="6" data-dots="true" data-nav="false" data-stage-padding="2" data-loop="false" data-margin="30" data-mouse-drag="false"><a class="link-corporate" href="#"><img src="images/brand-1-inverse-183x44.png" alt="" width="183" height="44"/></a><a class="link-corporate" href="#"><img src="images/brand-2-inverse-118x82.png" alt="" width="118" height="82"/></a><a class="link-corporate" href="#"><img src="images/brand-3-inverse-137x39.png" alt="" width="137" height="39"/></a><a class="link-corporate" href="#"><img src="images/brand-4-inverse-133x77.png" alt="" width="133" height="77"/></a><a class="link-corporate" href="#"><img src="images/brand-5-inverse-153x30.png" alt="" width="153" height="30"/></a><a class="link-corporate" href="#"><img src="images/brand-6-inverse-90x68.png" alt="" width="90" height="68"/></a><a class="link-corporate" href="#"><img src="images/brand-7-inverse-112x43.png" alt="" width="112" height="43"/></a><a class="link-corporate" href="#"><img src="images/brand-8-inverse-126x22.png" alt="" width="126" height="22"/></a><a class="link-corporate" href="#"><img src="images/brand-9-inverse-158x33.png" alt="" width="158" height="33"/></a><a class="link-corporate" href="#"><img src="images/brand-10-inverse-137x37.png" alt="" width="137" height="37"/></a><a class="link-corporate" href="#"><img src="images/brand-11-inverse-84x59.png" alt="" width="84" height="59"/></a><a class="link-corporate" href="#"><img src="images/brand-12-inverse-116x51.png" alt="" width="116" height="51"/></a></div>
            </div>
        </div>
    </section>
    <!-- Steps-->
        ...
        <div class="container">
            ...
            <div class="row row-30 row-xl-70">
                <div class="col-12 col-lg-4">
                    <!-- Post Minimal-->
                    <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src="images/blog-1-369x253.jpg" alt="" width="369" height="253"/></a>
                        <div class="post-minimal-main">
                            ...
                            <time class="post-minimal-time" datetime="2019">November 23, 2019</time>
                        </div>
                    </article>
                </div>
                <div class="col-12 col-lg-4">
                    <!-- Post Minimal-->
                    <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src="images/blog-2-369x253.jpg" alt="" width="369" height="253"/></a>
                        <div class="post-minimal-main">
                ...
                <div class="col-12 col-lg-4">
                    <!-- Post Minimal-->
                    <article class="post-minimal"><a class="post-minimal-media" href="blog-post.html"><img class="post-minimal-image" src="images/blog-3-369x253.jpg" alt="" width="369" height="253"/></a>
                        <div class="post-minimal-main">
    ...
    <section class="section section-md bg-default text-center">
        <div class="container">
            ...
            <p class="offset-top-20px"><span style="max-width: 670px;">Searching for jobs has never been that easy. Now you can find job matched your career expectation, apply for jobs and receive feedback right on your mobile. Start your job search now!</span></p>
