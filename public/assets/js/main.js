...
(function ($) {
  ...
  */
  ...
  var numberSpinner = (function () {
    $('.itemCountr_manual1 .btn_counter1').click(function () {
      var btn = $(this),
        oldValue = btn.closest('.itemCountr_manual1').find('input').val().trim(),
        newVal = 0;
    ...
    $('.itemCountr_manual1 .input_no1').keypress(function (evt) {
      evt = (evt) ? evt : window.event;
      var charCode = (evt.which) ? evt.which : evt.keyCode;
      if (charCode > 31 && (charCode < 48 || charCode > 57)) {
        return false;
